...
use log::{error, info};
use ndk::native_window::FrameRateCompatibility;
                        ...
                        match main_event {
                            ...
                            MainEvent::InitWindow { .. } => {
                                ...
                                if let Some(native_window) = &native_window {
                                    native_window.set_frame_rate(30.0, FrameRateCompatibility::Default).unwrap();
                                }
                            }
                ...
                if redraw_pending {
                    if let Some(native_window) = &native_window {
                        ...
                        match app.input_events_iter() {
                            ...
                            Err(err) => error!("Failed to iterate input events: {:#?}", err),
                        }
